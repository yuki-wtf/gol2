...
export const StyledPlayPause = styled.button`
  ...
  align-items: center;
  align-self: center;
  border: 2px solid ${(p) => p.theme.colors.buttonPrimary.defaultBorder};
  border-radius: 50%;
  text-align: center;

  background: ${(p) => p.theme.colors.buttonPrimary.defaultBackground};
  color: ${(p) => p.theme.colors.buttonPrimary.defaultColor};
  &:hover {
    ${(p) =>
      !p.disabled &&
      css`
  ...
  &:active {
    background: ${(p) => p.theme.colors.buttonPrimary.activeBackground};
  }
`
