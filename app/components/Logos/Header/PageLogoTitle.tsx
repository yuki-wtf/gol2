...
const StyledSvg = styled.svg<{
  ...
  .path-1 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path1};
  }
  .path-2 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path2};
  }
  .path-3 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path3};
  }
  .path-4 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path4};
  }
  .path-5 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path5};
  }
  .path-6 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path6};
  }
  .path-7 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path7};
  }
  .path-8 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path8};
  }
  .path-9 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path9};
  }
  .path-10 {
    fill: ${(props) => props.theme.colors.logoVariants[props.variant].path10};
    stroke: ${(props) => props.theme.colors.logoVariants[props.variant].path1};
  }
`
    ...
    <StyledContainer>
      <StyledLogo>
        ...
        >
          ...
          />
          <path className="path-3" d="M5.498 12.222l4.684-2.715 4.684 2.715-4.23 2.45a1 1 0 01-.908 0l-4.23-2.45z" />
          <path
            className="path-4"
