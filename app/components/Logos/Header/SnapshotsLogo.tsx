...
const StyledPageTitle = styled.div`
  ...
  display: flex;
  align-items: center;
  color: ${(props) => props.theme.colors.snapshotsPrimary};
  &:before {
    content: '';
    width: 1px;
    height: 17px;
...
const SnapshotsLogo = (props) => {
  return (
    <StyledContainer>
      <StyledLogo>
        <svg width={78} height={27} viewBox="0 0 78 27" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
          ...
          <path
            ...
            fill="#DC618A"
          />
          <path d="M5.498 12.222l4.684-2.715 4.684 2.715-4.23 2.45a1 1 0 01-.908 0l-4.23-2.45z" fill="#D25B82" />
          <path
      ...
      <StyledPageTitle>
        <Typography.GolRegular>Snapshots</Typography.GolRegular>
      </StyledPageTitle>
    </StyledContainer>
  )
}

export default SnapshotsLogo
