      ...
      <ThemeProvider theme={infinite}>
        ...
        <ErrorContainer>
          {error.message === 'Failed to fetch' ? (
            <>
              <Typography.H2>Failed to connect to the server</Typography.H2>
              <Typography.H3>Check your internet connection and try again</Typography.H3>
            </>
          ) : (
            <>
              <Typography.H2>Something has broken</Typography.H2>
              <Typography.H3>{error.message}</Typography.H3>
            </>
          )}
        </ErrorContainer>
      </ThemeProvider>
